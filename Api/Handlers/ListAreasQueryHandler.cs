...
public sealed class ListAreasQueryHandler(IAreaRepository areaRepository, ICurrentUserAccessor currentUser)
    : IRequestHandler<ListAreasQuery, List<AreaResponse>>
{
    ...
    {
        var entities = await areaRepository.GetAllAsync(currentUser.UserId, ct);
